          ...
          <div className="flex-1 flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <div className="space-y-5 max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-neutral-600 leading-relaxed font-medium">
                I'm a TikTok creator obsessed with finding and sharing the absolute cutest, most aesthetic products online.
              </p>
              <p className="text-lg md:text-xl text-neutral-600 leading-relaxed font-medium">
                On this page, you'll find direct shopping links and my 100% honest reviews for every item featured in my videos. No gatekeeping, no redirection scams—just cozy vibes and products I truly love.
              </p>
            </div>
